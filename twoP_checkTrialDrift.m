function [rejIdx, rampVal] = twoP_checkTrialDrift(data, lowLim, highLim, trialIdx, makePlot)
...
fprintf('Rejected %d/%d neurons because of drift over the session\n', sum(rejIdx), size(traces,2))
...
if makePlot
    ...
    xlim([0 1]); nvline(lowLim); nvline(highLim); axis square
