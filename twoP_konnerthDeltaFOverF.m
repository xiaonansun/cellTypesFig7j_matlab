function dFOF = twoP_konnerthDeltaFOverF(activity, pmtOffFrs, smoothPts, minPts)
...
%make sure smoothPts is uneven
smoothPts = ceil(smoothPts/2)*2-1;
...
for ivalid = 1:length(begs)
    ...
    %% Smooth    
    runningF = smoothCol(activity, 1, smoothPts, 'box');
