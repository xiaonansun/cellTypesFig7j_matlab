...
[status, result] = system(['python ' which('s2ptomat.py') ' ' suite2p_output_dir]); % Converts ops.npy and stat.npy to ops.mat and stat.mat
...
bin_MScan_dir = [suite2p_base_dir filesep animal filesep 'imaging' filesep session filesep]; 
